...
\begin{symposium}{RSS Pioneers Workshop \emph{(virtual due to COVID-19)}}{}{2020\\}
  Selective annual workshop in conjunction with the Robotics: Science and Systems conference (RSS).
  Designed to ``bring together a cohort of the world's top early career researchers to foster
  creativity and collaborations surrounding challenges in all areas of robotics.''\footnote{From the
    \hyperlink{https://sites.google.com/view/rsspioneers2020\#h.p\_uRuKS3yP_C3Y}{RSS Pioneers 2020
  website}.} (\emph{33.7\% acceptance rate})
\end{symposium}
...
\section{Service}
\begin{loneboldlist}
	\item[Reviewer:] ICRA (2016, 2019, 2020), IROS (2019), MRS (2019), RO-MAN (2016), RSS (2019),
	WAFR (2018), AURO, and SIMPAR (2018).
	\item[Departmental Service:] Colloquim Czar (2016--2020), Administrative Colloquium Czar
	(2016--2019), Ph.D. Mentor Czar (2016--2018)
\end{loneboldlist}
