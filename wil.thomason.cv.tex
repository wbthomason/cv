...
\begin{tabu} to 1.0\textwidth {X[l]X[r]}
	...
	107 Hoy Road                   &                                   \\
	Ithaca, NY 14853                                                   \\
	\href{https://www.cs.cornell.edu/~wil/}{\nolinkurl{https://www.cs.cornell.edu/~wil/}}
\end{tabu}
...
Ithaca, NY\hfill{August 2015 -- Present}
\begin{innerlist}
	\item[] Ph.D., Computer Science
\end{innerlist}\bigskip

\href{https://www.cs.cornell.edu}{\textbf{Cornell University}},
Ithaca, NY\hfill{June 2019}
\begin{innerlist}
	\item[] MS, Computer Science
	\item[] \textbf{Relevant Courses:}
    Graduate Algorithms, Advanced Machine Learning, Graduate Programming Languages, Intelligent
    Sensor Planning and Control, Mobile Robot Manipulation, Formal Methods for Robotics
\end{innerlist}\bigskip
...
\textbf{Automatic Distributed Multi-Agent Coordination of Single-Agent Robot Controllers.}
\emph{ICRA (in submission)} (2019)
\begin{innerlist}
...
\textbf{Louis T. Rader Outstanding Education Undergraduate Student Award} \hfill \textit{University of Virginia Department of Computer Science}, May 2015
\begin{innerlist}
...
\begin{innerlist}
	\item[] Advised by Professor Ross Knepper, I have studied problems in the domains of integrated
	task and motion planning, human-robot interaction and multi-agent planning. Specifically, I
	have made advances in efficient task and motion planning, gesture recognition, and
	coordination for ad hoc teams of heterogeneous robots. This work has resulted in several
	publications and presentations, and is ongoing.
\end{innerlist}\bigskip
...
\begin{innerlist}
	\item[] I worked with Professor Westley Weimer on automatic software functionality
...
\emph{The University of Virginia, Department of Computer Science}
\begin{innerlist}
	\item[] As a part of Professor Gabriel Robins' lab, I helped to create an efficient, scalable
	system for real-time localization of objects in 3D space using passive RFID tags. In addition
	to designing and running experiments for the system, I researched and created a novel approach
	to distinguishing between noisy measurements and measurements corresponding to moving objects.
	This approach, which was based on a sliding-window particle filter, significantly increased
	the accuracy of our system. This work resulted in a journal publication.
\end{innerlist}
...
\textbf{Programming Languages:} C++, Python, Rust, C, CL, Haskell, OCaml\\
\textbf{Technologies:} Linux, ROS, OMPL, PyTorch, TensorFlow, Git, CUDA
...
Taught middle school girls from at-risk communities about programming
