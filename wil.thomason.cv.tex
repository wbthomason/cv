...
\makeatother
% TODO: Find a cleaner way to define these both
\newenvironment{confpub}[5][]{\addtocounter{cpublicationsTot}{1}\addtocounter{cpublications}{-1}\setlength{\parskip}{0pt}%
	...
	\end{itemize}}{}
\newenvironment{journpub}[5][]{\addtocounter{jpublicationsTot}{1}\addtocounter{jpublications}{-1}\setlength{\parskip}{0pt}%
	\begin{itemize}[leftmargin=*,labelindent=0pt,nolistsep]%
		\setlength{\parskip}{0pt}%
		\item[(\thejpublications)]{#2}.\linebreak[0]\emph{#3}. #4 #5\ifnonempty{#1}{, #1}.%
	\end{itemize}}{}
